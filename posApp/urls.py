...
urlpatterns = [
    ...
    path('users', views.my_users, name='users-page'),
    ...
    # Employee
    path('traction_code', views.transaction_code, name='transaction_code'),
    path('reciept_code', views.reciept_code, name='reciept_code'),
    path('validation', views.validation, name='validation'),
    path('update_receipt', views.update_receipt, name='update_receipt'),
